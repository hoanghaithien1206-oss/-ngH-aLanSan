...
var Zn = {
  ...
  DEBOUNCE_DELAY: 500,
    CHARACTER_ALIASES: {
    "hua_thinh_vu": ["Hứa Thính Vũ"],
    "ngu_tich_nhan": ["Ngu Tịch Nhan", "Ngu Tịch", "Ngu Nhan"],
    "bach_thanh_huyen": ["Bạch Thanh Huyền"],
    "nam_cung_van_thuong": ["Nam Cung Vân Thường"],
    "mong_yeu_linh": ["Mộng Yểu Linh"],
    "nguyen_vong_uu": ["Nguyễn Vong Ưu"],
    "van_duong": ["Vãn Đường"],
    "soc_ly_oanh": ["Sóc Ly Oanh", "A Oanh", "Huyết Thủ Phi Oanh"],
    "soc_vong_thu": ["Sóc Vọng Thư", "Xích Nguyệt Nữ Đế", "U Ảnh Tông Chủ"]
  },
...
var ja = [
  ...
  },
  {
    ...
    shouldEnable: (e, t) => {
      ...
      let r = n[2];
      if (r === "Kỳ Tâm Động" || r === "Kỳ Rung Tâm") r = "Kỳ Rung Động";
      const canonicalA = $a(a).mainCharacterName;
      const s = e.mvuData?.hong_nhan?.[canonicalA];
      if (!s)
        return (
          Zn.DEBUG &&
            console.log(
