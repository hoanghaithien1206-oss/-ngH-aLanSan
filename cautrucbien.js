...
const f = e.z.object({
  ...
  p = new Set(["linh_thach", "Hạ Phẩm Linh Thạch"]);
function m(r) {
  return String(r ?? "")
    .trim()
    .replace(/\s+/g, "");
...
const v = e.z
    .object({
      ten: e.z.string().prefault(""),
      mo_ta: e.z.string().prefault(""),
      loai: e.z.enum(["cong_phap", "Thần Thông", "Bí Thuật"]).prefault("Thần Thông"),
      pham_cap: e.z
        .string()
...
const B = e.z.object({
    ...
    cong_phap: e.z.string().describe("cong_phap"),
...
const rr = e.z
  ...
  ir = e.z.object({
    ...
    loai: e.z.enum(["Bí Cảnh", "Thành Trấn", "tong_mon", "Cấm Địa", "Di Tích", "Địa Hình"]),
  ...
  .object({
    ...
    kho_dia_diem: e.z
      ...
      .prefault({
        ...
        "Huyền Băng Sơn": { vuc: "Bắc Minh", loai: "tong_mon", nguy: 50, dac: "Huyền Vũ Tông", tai_nguyen: ["Huyền Băng"] },
        "Quy Khương Nhãn": {
          vuc: "Bắc Minh",
          loai: "Cấm Địa",
          nguy: 99,
